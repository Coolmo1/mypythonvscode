...
if avr < 2.5:
    st.write("You are not eligable for scholarship")
elif avr >= 2.5 and avr <3:
    st.write("You are eligable fo a partial scholarship")
elif avr >= 3 and avr <3.5:
    st.write("You are eligable fo a half scholarship")
elif avr == 4:
    st.write("You are eligable fo a full scholarship")
